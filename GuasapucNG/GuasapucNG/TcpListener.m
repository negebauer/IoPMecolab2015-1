...
@property (assign, nonatomic) NSRunLoop *loop;
//@property (assign, nonatomic) NSMutableArray *inStreamArray;
//@property (assign, nonatomic) NSMutableArray *outStreamArray;
@property (assign, nonatomic) int conexiones;
